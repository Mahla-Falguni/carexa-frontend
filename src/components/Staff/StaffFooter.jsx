import { FaUserMd, FaHeart, FaShieldAlt, FaEnvelope } from "react-icons/fa";
                ...
                <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2.5">
                        <div className="w-7 h-7 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center">
                            <FaUserMd className="text-white" size={12} />
                        </div>
                        ...
                        <span className="text-slate-400 text-xs hidden sm:inline">Staff Portal</span>
                    </div>

                    {/* Copyright */}
                    <p className="text-slate-400 text-xs flex items-center gap-1.5">
                        © {year} Carexa. Designed and Developed by Survivor Infotch.
